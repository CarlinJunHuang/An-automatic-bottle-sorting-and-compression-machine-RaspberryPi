...
#
PUL = 18  # Stepper Drive Pulses
DIR = 12  # Controller Direction Bit (High for Controller default / LOW to Force a Direction Change).
...
durationBwd = 50000 # This is the duration of the motor spinning. used for reverse direction
